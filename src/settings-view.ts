  ...
  getSettingDefinitions(): SettingDefinitionItem[] {
    return [
      ...
      { /* Molecule visualization group */
        ...
        items: [
          {
            name: 'Click to test plugin with live preview',
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: 'Experimental SSSR?',
            desc: 'Experimental algorithm, smallest set of smallest rings.  (default: false)',
            control: {type: 'toggle', key: 'experimentalSSSR', defaultValue: DEFAULT_SETTINGS.experimentalSSSR},
          },
          {
